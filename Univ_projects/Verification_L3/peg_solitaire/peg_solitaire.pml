...
r[0].c[0]=UNDEF; r[0].c[1]=UNDEF; r[0].c[5]=UNDEF; r[0].c[6]=UNDEF; r[1].c[0]=UNDEF; r[1].c[1]=UNDEF; r[1].c[5]=UNDEF; r[1].c[6]=UNDEF; r[5].c[0]=UNDEF; r[5].c[1]=UNDEF; r[5].c[5]=UNDEF; r[5].c[6]=UNDEF; r[6].c[0]=UNDEF; r[6].c[1]=UNDEF; r[6].c[5]=UNDEF; r[6].c[6]=UNDEF; 
/* ----- Add first hole ----- */
